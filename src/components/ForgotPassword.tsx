          ...
          <div className="max-w-md sm:max-w-lg w-full">
            {!isSuccess ? (
              ...
              <div className="text-center">
                ...
                <button
                  onClick={() => window.location.href = '/'}
                  className={`w-full py-3 sm:py-4 px-4 border border-transparent text-sm sm:text-base font-medium rounded-lg text-white hover:opacity-90 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-opacity cursor-pointer ${
                    isDark ? 'focus:ring-offset-gray-900' : 'focus:ring-offset-white'
                  }`}
                  style={{ backgroundColor: colors.colors.primary }}
                >
