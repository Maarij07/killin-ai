      ...
      <div className="relative z-10 container mx-auto px-2 sm:px-4 py-8 sm:py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8 max-w-7xl mx-auto px-4">
          {pricingPlans.map((plan) => (
            <div
              key={plan.id}
              className={`relative rounded-3xl transition-all duration-300 hover:scale-105 hover:shadow-2xl flex flex-col h-[600px] ${plan.featured ? 'scale-105' : ''} ${plan.id === 'enterprise' ? 'overflow-hidden' : ''
                }`}
              style={{
                    ...
                    <span className="text-6xl font-black" 
                      style={{
                        ...
                        background: plan.id === 'enterprise'
                          ...
                          : undefined,
                        backgroundClip: plan.id === 'enterprise' ? 'text' : undefined,
                        WebkitBackgroundClip: plan.id === 'enterprise' ? 'text' : undefined,
                        WebkitTextFillColor: plan.id === 'enterprise' ? 'transparent' : undefined
                      }}>
          ...
          <div className="max-w-8xl mx-auto px-4">
            <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="relative overflow-hidden rounded-3xl mb-6 p-8 h-[480px]"
                  ...
                  <div className="relative z-10 h-full">
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 h-[200px]">
                      {/* 100 Minutes Card */}
                      <div className="relative rounded-2xl p-4 group cursor-pointer hover:scale-105 transition-all duration-300 flex flex-col justify-between"
                        style={{
                          backgroundColor: isDark ? colors.colors.grey[800] : colors.colors.white,
                          border: `1px solid ${colors.colors.primary}40`,
                          boxShadow: `0 4px 15px -3px ${colors.colors.primary}20`
                        }}>
                        <div className="text-center">
                          ...
                          <div className="mb-3">
                            <span className="text-2xl font-black" style={{ color: isDark ? colors.colors.white : colors.colors.dark }}>$40</span>
                          </div>
                        </div>
                      ...
                      <div className="relative rounded-2xl p-4 group cursor-pointer hover:scale-105 transition-all duration-300 flex flex-col justify-between"
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-xs uppercase tracking-wide mb-3" style={{ color: isDark ? colors.colors.grey[400] : colors.colors.grey[600] }}>Minutes</p>
                          <div className="mb-3">
                            <span className="text-2xl font-black" style={{ color: isDark ? colors.colors.white : colors.colors.dark }}>$75</span>
                          </div>
                        </div>
                        <button className="w-full py-2 px-3 rounded-xl font-bold text-white text-sm uppercase tracking-wide transition-all duration-300 hover:opacity-90"
                          style={{ background: `linear-gradient(135deg, ${colors.colors.primary} 0%, ${colors.colors.primary}dd 100%)` }}>
                      ...
                      <div className="relative rounded-2xl p-4 group cursor-pointer hover:scale-105 transition-all duration-300 flex flex-col justify-between"
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-xs uppercase tracking-wide mb-3" style={{ color: isDark ? colors.colors.grey[400] : colors.colors.grey[600] }}>Minutes</p>
                          <div className="mb-3">
                            <span className="text-2xl font-black" style={{ color: isDark ? colors.colors.white : colors.colors.dark }}>$140</span>
                          </div>
                        </div>
                        <button className="w-full py-2 px-3 rounded-xl font-bold text-white text-sm uppercase tracking-wide transition-all duration-300 hover:opacity-90"
                          style={{ background: `linear-gradient(135deg, ${colors.colors.primary} 0%, ${colors.colors.primary}dd 100%)` }}>
                      ...
                      <div className="relative rounded-2xl p-4 group cursor-pointer hover:scale-105 transition-all duration-300 flex flex-col justify-between"
                        ...
                        <div className="text-center">
                          ...
                          <p className="text-xs uppercase tracking-wide mb-3" style={{ color: isDark ? colors.colors.grey[400] : colors.colors.grey[600] }}>Minutes</p>
                          <div className="mb-3">
                            <span className="text-2xl font-black" style={{ color: isDark ? colors.colors.white : colors.colors.dark }}>$260</span>
                          </div>
                        </div>
                        <button className="w-full py-2 px-3 rounded-xl font-bold text-white text-sm uppercase tracking-wide transition-all duration-300 hover:opacity-90"
                          style={{ background: `linear-gradient(135deg, ${colors.colors.primary} 0%, ${colors.colors.primary}dd 100%)` }}>
              ...
              <div className="lg:w-[30%] flex flex-col gap-6">
                ...
                <div className="relative rounded-2xl p-6 group cursor-pointer hover:scale-[1.01] transition-all duration-300 h-[480px] overflow-hidden"
                  style={{
                    backgroundColor: isDark ? colors.colors.grey[800] : colors.colors.white,
